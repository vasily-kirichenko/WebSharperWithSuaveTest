    ...
    Next:{
       ...
       Arrays.iteri(function(i)
       {
        return function(s)
        {
         return Snap1.When(s,function(x)
         {
          vs[0][i]=x;
          Ref.incr(d);
          return d[0]===c?Seq.forall(function(x1)
          {
           return Snap1.IsForever(x1);
     ...
     View1:Runtime.Class({},{
      ...
      Sequence:function(views)
      {
       return View.CreateLazy(function()
       {
        return Snap1.Sequence(Seq.map(function(_arg3)
        {
         return _arg3.$0.call(null,null);
        },views));
       });
      },
